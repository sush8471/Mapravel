  ...
  return (
    <motion.div
      ...
      transition={{ type: 'spring', damping: 28, stiffness: 200, delay: 0.1 }}
        className="w-full pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-4 overflow-hidden pointer-events-none"
        style={{ background: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.35) 40%, rgba(0,0,0,0.50) 100%)' }}
    >
      <div
        ref={containerRef}
        ...
        {locations.map((location, index) => {
          ...
          return (
            <div
              ...
              onClick={() => { haptic(); onLocationSelect(location); }}
            >
              {/* Connection line */}
