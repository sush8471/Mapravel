            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4">
                <button
                  ...
                  className="flex items-center p-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl transition-all group gap-4"
                >
                ...
                <button
                  onClick={() => { const t = encodeURIComponent(`Check out ${client.title} - A Digital Journey: ${window.location.href}`); window.open(`https://wa.me/?text=${t}`, '_blank'); }}
                  className="flex items-center p-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl transition-all group gap-4"
                >
                ...
                <button
                  onClick={() => { const t = encodeURIComponent(`Check out ${client.title} - A Digital Journey`); const u = encodeURIComponent(window.location.href); window.open(`https://twitter.com/intent/tweet?text=${t}&url=${u}`, '_blank'); }}
                  className="flex items-center p-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl transition-all group gap-4"
                >
